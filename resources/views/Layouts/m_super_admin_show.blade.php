		...
		<ul class="nav menu">
			...
			<li class="parent "> 
				<a data-toggle="collapse" href="#sub-item-9">
					<span class="glyphicon glyphicon-list"></span> Comisiones <span data-toggle="collapse" href="#sub-item-9" class="icon pull-right"><em class="glyphicon glyphicon-s glyphicon-plus"></em></span> 
				</a>
			...
			<li class="parent ">
				<a data-toggle="collapse" href="#sub-item-10">
					<span class="glyphicon glyphicon-list"></span> Movimientos <span data-toggle="collapse" href="#sub-item-10" class="icon pull-right"><em class="glyphicon glyphicon-s glyphicon-plus"></em></span> 
				</a>
